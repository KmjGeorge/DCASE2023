spectrum_config = {
    ...
    'hop_length': 500,
    'n_mels': 128,
    'freqm': 20,  # specaugment参数 频率掩膜
    'timem': 20,  # specaugment参数 时间掩膜
...
dataset_config = {
    ...
    'h5path': 'D:/github/DCASE2023/dataset/h5/tau2022.h5',
    'num_classes': 10,
    'shuffle': True,
    # 当使用tau2022_random_slicing数据集时使用以下三项，否则为None
    'reassembled_audio_path': 'G:/datasets/TAU-urban-acoustic-scenes-2022-mobile-development-reassembled',
    'reassembled_meta_path': 'G:/datasets/TAU-urban-acoustic-scenes-2022-mobile-development-reassembled/meta.csv',
...
dataset_config = {
    'name': 'urbansound8k',
    'batch_size': 64,
    'meta_path': 'G:/datasets/urbansound8k/metadata/urbansound8k.csv',
    'audio_path': 'G:/datasets/urbansound8k/audio/',
    'num_classes': 10,
    'h5path': None,
    'shuffle': True,
    'reassembled_audio_path': None,
