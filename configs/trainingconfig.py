...
distillation_config = {
    'task_name': 'passt+mobileastv3_light nomvit2 SiLU fc=160 DKD T=2 alpha=1 beta=8 MixStyle(0.3 0.6) Mixup(0.3 1) 1e-3(30) 1e-2(400)',
    # 任务名，用于模型文件和日志命名
    'epoch': 600,
    'start_epoch': 0,
    ...
    'student_model': 'mobileast_light_small',
    'T': 2,  # 蒸馏温度
